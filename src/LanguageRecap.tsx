...
type SectionForm = { section_type: SectionType; title: string; content: string; position: number }
...
const emptyForm = (position: number): SectionForm => ({ section_type: 'vocabulary', title: '', content: '', position })
...
export default function LanguageRecap({ selectedLanguage }: Props) {
  ...
  const startEditing = (section: Section) => {
    ...
    setForm({ section_type: section.section_type, title: section.title, content: section.content, position: section.position })
  }
